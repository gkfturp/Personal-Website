...
import { useEffect, createContext, useContext, useState, memo, useRef, startTransition, useId, Fragment as Fragment$1, isValidElement, useSyncExternalStore, useDeferredValue, useReducer, lazy, Suspense } from "react";
...
function usePerspectiveSync(comlink2, dispatch) {
  ...
  }, t1 = [comlink2, dispatch], $[0] = comlink2, $[1] = dispatch, $[2] = t0, $[3] = t1) : (t0 = $[2], t1 = $[3]), useEffect(t0, t1);
}
function _temp$5() {
}
...
function Overlays(props) {
  ...
  }, t3 = [comlink2], $[1] = comlink2, $[2] = t2, $[3] = t3) : (t2 = $[2], t3 = $[3]), useEffect(t2, t3), usePerspectiveSync(comlink2, dispatch);
  let t4, t5;
  ...
  }, t5 = [onPerspectiveChange, perspective], $[4] = onPerspectiveChange, $[5] = perspective, $[6] = t4, $[7] = t5) : (t4 = $[6], t5 = $[7]), useEffect(t4, t5), useReportDocuments(comlink2, elements, perspective);
  let t6;
  ...
  bb0: {
    ...
    let t142;
    $[19] !== comlink2 || $[20] !== componentResolver || $[21] !== dragMinimapTransition || $[22] !== dragShowMinimap || $[23] !== elements || $[24] !== inFrame || $[25] !== isDragging || $[26] !== optimisticActorReady || $[27] !== props.plugins || $[28] !== shouldHideActions || $[29] !== wasMaybeCollapsed ? (t142 = elements.filter(_temp0).map((t152) => {
      const {
        id,
        element: element_0,
        focused,
    ...
    }), $[19] = comlink2, $[20] = componentResolver, $[21] = dragMinimapTransition, $[22] = dragShowMinimap, $[23] = elements, $[24] = inFrame, $[25] = isDragging, $[26] = optimisticActorReady, $[27] = props.plugins, $[28] = shouldHideActions, $[29] = wasMaybeCollapsed, $[30] = t142) : t142 = $[30], t13 = t142;
  }
  ...
  let t18;
  $[34] !== comlink2 || $[35] !== inFrame || $[36] !== inPopUp || $[37] !== overlayEnabled || $[38] !== rootElement || $[39] !== updateDragPreviewCustomProps ? (t18 = /* @__PURE__ */ jsx(OverlaysController, { comlink: comlink2, dispatch, inFrame, inPopUp, onDrag: updateDragPreviewCustomProps, overlayEnabled, rootElement }), $[34] = comlink2, $[35] = inFrame, $[36] = inPopUp, $[37] = overlayEnabled, $[38] = rootElement, $[39] = updateDragPreviewCustomProps, $[40] = t18) : t18 = $[40];
  let t19;
  ...
  let t23;
  $[62] !== comlink2 || $[63] !== t22 ? (t23 = /* @__PURE__ */ jsx(SharedStateProvider, { comlink: comlink2, children: t22 }), $[62] = comlink2, $[63] = t22, $[64] = t23) : t23 = $[64];
  let t24;
  $[65] !== comlink2 || $[66] !== t23 ? (t24 = /* @__PURE__ */ jsx(PreviewSnapshotsProvider, { comlink: comlink2, children: t23 }), $[65] = comlink2, $[66] = t23, $[67] = t24) : t24 = $[67];
  let t25;
  $[68] !== comlink2 || $[69] !== elements || $[70] !== t24 ? (t25 = /* @__PURE__ */ jsx(SchemaProvider, { comlink: comlink2, elements, children: t24 }), $[68] = comlink2, $[69] = elements, $[70] = t24, $[71] = t25) : t25 = $[71];
  let t26;
  ...
  let t28;
  return $[78] !== comlink2 || $[79] !== t27 ? (t28 = /* @__PURE__ */ jsx(TelemetryProvider, { comlink: comlink2, children: t27 }), $[78] = comlink2, $[79] = t27, $[80] = t28) : t28 = $[80], t28;
}
function _temp0(e_1) {
